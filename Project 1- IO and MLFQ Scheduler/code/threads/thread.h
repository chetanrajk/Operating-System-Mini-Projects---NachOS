...
class Thread {
  ...
  public:
    ...
    void setPreempt(bool preemp);

    int starvation;  // To handle aging

    bool blocked;   // If thread is blocked by other thread
...
// while executing kernel code.
    ...
    int userRegisters[NumTotalRegs];	// user-level CPU register state
	  ...
	  int priority;
    int quantRemain;
    bool preempted;  // For I/O interrupts from threads
